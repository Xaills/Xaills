...
leonid = {
    ...
    "location"     : "Russia",
    "role"         : "Solo Developer",
    "main_project" : "Zion Tunnel — self-hosted commercial VPN service",
    "stack"        : ["Node.js", "Python", "Linux", "Docker", "Xray-core"],
    "interests"    : ["VPN/DPI bypass", "Telegram bots", "Cybersecurity", "Minecraft modding"],
    "side_quests"  : ["DIY electric buggy ⚡", "Theatre & acting 🎭", "AI-assisted dev 🤖"],
    "currently"    : "Migrating ZionTunnel → RemnaWave + building Forge Parasite biome mod",
}
```

I build things **end-to-end** — from idea and backend logic to VPS deployment, nginx config, monitoring and real paying users. If it can run on a Linux server and serve people through Telegram, I'm interested.

---

## 🔒 Zion Tunnel — Main Project

<table>
<tr>
<td width="50%">

**Self-hosted VPN service** with paying subscribers, managed entirely through Telegram.
...
```
🔄  ZionTunnel → RemnaWave migration
    ├── Panel: partially deployed on NL node
    ├── Version: RemnaWave v2.7.4
    └── Status: in progress

🎮  Parasite Biome — Forge 1.16.5 mod
